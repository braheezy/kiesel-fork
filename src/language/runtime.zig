...
pub fn evaluateImportCall(agent: *Agent, specifier: Value, options: Value) Agent.Error!Value {
    ...
    if (!options.isUndefined()) {
        ...
        // f. Sort attributes according to the lexicographic order of their [[Key]] field, treating
...
pub fn methodDefinitionEvaluation(
    ...
    switch (method_definition.method) {
        ...
        .method => |function_expression| {
            ...
            // 3. Return ? DefineMethodProperty(object, methodDef.[[Key]], methodDef.[[Closure]],
            //    enumerable).
        ...
        .get => |function_expression| {
            ...
            // 5. Let formalParameterList be an instance of the production
            ...
            switch (property_key_or_private_name) {
                ...
                .private_name => |private_name| {
                    // a. Return PrivateElement { [[Key]]: propKey, [[Kind]]: accessor,
        ...
        .async_generator => |async_generator_expression| {
            ...
            //    sourceText, UniqueFormalParameters, AsyncGeneratorBody, non-lexical-this, env,
            //    privateEnv).
            const closure = try ordinaryFunctionCreate(
                agent,
...
pub fn classDefinitionEvaluation(
    ...
    //         i. If classPrivateEnvironment.[[Names]] contains a Private Name pn such that
    //            pn.[[Description]] is dn, then
    ...
    for (elements, pre_evaluated_element_names) |class_element, pre_evaluated_name| {
        ...
        if (element != null) switch (element.?) {
            ...
            .private_method_definition => |private_method_definition| {
                ...
                // iv. If container contains a PrivateElement pe such that pe.[[Key]] is
                //     element.[[Key]], then
